...
function NewsRow({ article, showImage = true }) {
  ...
  return (
    <Link 
      ...
      className="flex items-start gap-3 p-2 hover:bg-gray-50 border-b border-gray-200 last:border-0 group"
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <h3 className="text-[13px] font-semibold text-gray-900 group-hover:text-gray-600 line-clamp-2 leading-tight">
          {article.title}
        </h3>
        ...
        {article.transfer_probability > 0 && (
          <div className="flex items-center gap-1 mt-1">
            ...
            <span className="text-[10px] font-bold text-gray-500">{article.transfer_probability}%</span>
          </div>
        )}
      </div>
...
function TrendingItem({ item, rank }) {
  return (
    <Link 
      ...
      className="flex items-center gap-2 px-3 py-1.5 hover:bg-gray-50 border-b border-gray-100 last:border-0"
    >
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              {hasMore && !loading && filteredArticles.length > 0 && (
                <div className="p-3 border-t border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                  <button
                    onClick={loadMore}
                    className="w-full py-2.5 text-[12px] font-semibold text-white bg-gray-700 hover:bg-gray-800 rounded-full transition-all duration-200 shadow-sm"
              ...
              <nav>
                {[
                  ...
                  <Link
                    key={item.path}
                    to={item.path}
                    className="flex items-center justify-between px-3 py-2 hover:bg-gray-50 border-b border-gray-100 last:border-0 group"
                  >
                    <span className="text-[12px] text-gray-900 group-hover:text-gray-600 flex items-center gap-2">
